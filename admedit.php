										...
										<div class="m-portlet__body">
											<div class="m-form__section m-form__section--first">
												...
												<legend style="font-weight: bold; font-family: helvetica;">Ad Hoc</legend>
																						...
																						<br>		
																							<label for="example_input_full_name"  style="font-weight: bold; font-family: helvetica;">
																									...
																									<input type="text" name="color[]" id="color2" class="form-control m-input" style="width: 200px; margin-left: 182px; margin-top: -33px;" placeholder="" value="<?php echo $r['ColorCode']?>" >
																					...
																					<br>			<label for="example_input_full_name"  style="font-weight: bold; font-family: helvetica;">
																								...
																								<input type="text" name="color[]" id="col" class="form-control m-input" style="width: 200px; margin-left: 182px; margin-top: -33px;" value="" placeholder="">
												...
												<div class="form-group m-form__group  <?php echo (!empty($uname_err)) ? 'has-error' : ''; ?>" id="ccode1">
													...
													<input type="text" name="ln" id="ln" class="form-control m-input" style="width: 200px; margin-left: 180px; margin-top: -33px;" placeholder="" value="<?php echo $ln?>" pattern="[A-Za-z0-9,./'`'@$%&]{1,}" title="Blankspace Not allowed" required>
												...
												<div class="form-group m-form__group" >
													...
													<div>
														<textarea  placeholder="Comments Here" style="size: 100%; margin-left:180px; height: 80px; width: 210px; margin-top: -38px"  name="cmt" type="text" class="txt_3" value="<?php echo $cmt?>" pattern="[A-Za-z0-9,./'`'@$%&]{1,}" title="Blankspace Not allowed"><?php echo $cmt?></textarea>
