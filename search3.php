...
$query = "SELECT * FROM teledata WHERE Ext_No like '$q%' OR BlockName like '$q%' OR Uname like '$q%' OR C_code like '$q%' OR ECN like '$q%' OR ECC like '$q%' OR SCN like '$q%' OR SCC like '$q%' OR LNode like '$q%' OR Type like '$q%' OR Comments like '$q%'";
